...
public abstract class TableroEmpezandoAncestroTest {
	...
	@Test
	void comprobarColocacionMinasEmpezandoEnCeldaCeroCero() throws CoordenadasIncorrectasException {
		final int fila = obtenerFilaInicio();
		final int columna = obtenerColumnaInicio();
		tablero.colocarMinas(new Celda(fila, columna), new DistanciaChebyshev(), new Random(fila * 10L + columna));
		...
		for (int i = 0; i < obtenerPosicionMinas().length; i++) { // al primer fallo el test para...
			...
			assertThat("El número de minas adyacentes a una mina es incorrecto",
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero 
	 */
	void comprobarNumero(int[][] posiciones, int numeroMinasAdyacentes) throws CoordenadasIncorrectasException {
		final int fila = obtenerFilaInicio();
		final int columna = obtenerColumnaInicio();
		tablero.colocarMinas(new Celda(fila, columna), new DistanciaChebyshev(), new Random(fila * 10L + columna));
		int contador = 0;
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
	 */
	void descubrirCeldaInicial() throws CoordenadasIncorrectasException {
		final int fila = obtenerFilaInicio();
		final int columna = obtenerColumnaInicio();
		tablero.colocarMinas(new Celda(fila, columna), new DistanciaChebyshev(), new Random(fila * 10L + columna));
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
	 */
	void marcarTodasLasMinas() throws CoordenadasIncorrectasException {
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
	 */
	void descubrirTodasLasMinas() throws CoordenadasIncorrectasException {
		for (int i = 0; i < obtenerPosicionMinas().length; i++) {
	 ...
	 * @throws CoordenadasIncorrectasException si las coordenadas están fuera del tablero
	 */
	void comprobarCeldaDescubiertasInicialmente(int[][] posiciones) throws CoordenadasIncorrectasException {
		for (int i = 0; i < posiciones.length; i++) { // al primer fallo el test para...
			Celda celda = tablero.obtenerCelda(posiciones[i][0], posiciones[i][1]);
	...
	@Test
	void comprobarEstadoAlDescubrirCeroCero() throws CoordenadasIncorrectasException {
	...
	@Test
	void comprobarSolucionAlDescubrirCeroCero() throws CoordenadasIncorrectasException {
		descubrirCeldaInicial();
	...
	@Test
	void comprobarMarcarTodasLasMinas() throws CoordenadasIncorrectasException {
		descubrirCeldaInicial();
		marcarTodasLasMinas();
	...
	@Test
	void comprobarDescubrirTodasLasMinas() throws CoordenadasIncorrectasException {
		descubrirCeldaInicial();

...
public class Conversor {
	 ...
	 */
	public String aMinusculas(String s) throws CException {
		if (s.charAt(0)=='x') {
			throw new CException("Error con cadena comenzando con x" + s);
		}
	 ...
	 */
	public String aMayusculas(String s) throws BException {
		if (s.charAt(0)=='y') {
			throw new BException("Error con cadena comenzando con y"+ s);
		}
